...
public class MySqlDialect extends Dialect {
    ...
    @Override
    public String sql_pagelist(String sql, int offsetIndex, int pageSize) {
        if (offsetIndex > 0) {
            return sql + " limit " + offsetIndex*pageSize + "," + pageSize;
        } else {
    ...
    @Override
    public String convertJavaStringToSqlType(String type, Integer length,
    		Integer scale) {
